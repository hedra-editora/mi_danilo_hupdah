...
mostrava que seu ``espírito'', \textit{ha̗͂wäg}, estava deixando seu corpo. Eu
não poderia mais acender seus cigarros, ouvir suas histórias nas rodas
de coca nem cantar com ele os caapivaiás.

O velho Henrique (\textit{B'o̖'}, falecido, \textit{Sokw'ä̗t Noh K'öd Tẽ̖h}) foi
...
tendo como referência o senhor Ponciano (\textit{Hu̖d}, 05/07/1946, \textit{Sokw'ä̗t Noh
K'öd Tẽ̖h)}. Uma outra, da qual participam em média 6 pessoas, se
forma próximo à casa do pajé Firmino (\textit{B'o̖'}, 06/07/1947, \textit{Sokw'ä̗t Noh
K'öd Tẽ̖h}). Em \textit{Ta̗t"-Dëh}, além de Firmino, Armando (\textit{Kä'},
05/01/1948, \textit{Sokw'ä̗t Noh K'öd Tẽ̖h}) também é identificado como
