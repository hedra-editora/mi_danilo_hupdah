...
Igarapé"-Taracuá, o \textit{Ta̗t"-Dëh}. Passadas algumas horas de navegação pelo
...
ou para fazer visitas e participar das festas de caxiri de \textit{Ta̗t"-Dëh}.
...
finalmente o porto de areia da comunidade de \textit{Ta̗t"-Dëh}. Tendo ouvido já
...
imensa saudade que passei a acenar aos moradores de \textit{Ta̗t"-Dëh}, que foram
...
\textit{Pu̗d"-dëh"-moh}, o Lago de Leite, os antepassados dos Hupd'äh viajaram
por muito tempo dentro da \textit{M'e̖h Hõh Tëg}, a Cobra"-Canoa. Depois de
ter chamado os seres humanos à existência, \textit{K'e̖g Te͂h} fez a Cobra"-Canoa
...
Cobra"-Canoa e vivem hoje nas \textit{Dëh"-Mo̖y}, Casas"-do"-Rio, que existem
...
em dia. Foi na cachoeira de Ipanoré, \textit{Hib'a̖h Hu͂h}, que os ancestrais dos
...
para a \textit{Paç Pö̗g}, a Serra Grande, onde coabitaria com seus
antepassados. Mais tarde, ascendendo, o percurso o levaria à casa do
criador, \textit{K'e̖g Te͂h}. ``No próximo ano não estarei mais aqui'', ele me
...
filho um sonho. Tinha sido levado para o fundo da Terra pelos \textit{K'öd
...
de campo em 2009 na aldeia de Taracuá"-Igarapé, \textit{Ta̗t"-Dëh}, tomávamos café
...
Taracuá"-Igarapé, \textit{Ta̗t"-Dëh}, na qual habitam aproximadamente 202
...
moram 38 grupos domésticos. O clã \textit{Sokw'ä̗t Noh K'öd Tẽ̖h} é majoritário e
...
identificam como pertencentes ao clã \textit{Dög M'e̖h Tẽ̖h D'äh}, grupo afim aos
\textit{Sokw'ä̗t Noh K'öd Tẽ̖h D'äh}. Essas famílias dizem ter pertencido
...
tendo como referência o senhor Ponciano.\footnote{\textit{Hu̖d}, 5 de julho de 1946, \textit{Sokw'ä̗t Noh
K'öd Tẽ̖h}.} Uma outra, da qual participam em média 6 pessoas, se
forma próximo à casa do pajé Firmino\footnote{\textit{B'o̖'}, 6 de julho de 1947, \textit{Sokw'ä̗t Noh
K'öd Tẽ̖h}.} Em \textit{Ta̗t"-Dëh}, além de Firmino, Armando\footnote{\textit{Kä'},
5 de janeiro de 1948, \textit{Sokw'ä̗t Noh K'öd Tẽ̖h}.} também é identificado como
...
\textit{Moy"-Höd}, Moradas Antigas, onde seus antepassados habitaram antes
de viver na grande aldeia de \textit{Ta̗t"-Dëh}. Chegam a lugares impregnados
...
deslocamento para a morada subterrânea dos \textit{K'ö̗d däh}, testemunhar sua
...
constituição e de diferenciação. Criados pelo herói cultural \textit{K'e̖g Te͂h},
...
``aquele que não tem fala'' ou ``aquele que não tem a nossa fala'',\footnote{\textit{Ma} é um prefixo privativo, e \textit{aku}, ``fala''.} sendo associado a ``selvagem'', a
...
velhos que veio de avião. Eles gostavam desse \textit{Haw}. Mas ele foi embora
...
Distante das comunidades, encontro"-me com o \textit{Haw} quase sempre. Seus
